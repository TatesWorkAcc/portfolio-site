        ...
        >
            ...
            <div className='grid-header'>
                <h1 className='project-text-header'>Weather App - November 2024</h1>
                    ...
                    ●	Implemented a search feature to fetch data based on city input, displaying current conditions and a 5-day forecast. <br></br><br></br>
                    ●	Displayed key metrics such as temperature, conditions, humidity, and descriptions in a user-friendly format. <br></br><br></br>
                    ●	Default data for New York City ensured a functional interface upon load. <br></br><br></br>
                    ●	Utilized responsive design principles for mobile and desktop views.  <br></br><br></br>
                    </p>
            </motion.div>
            <motion.div className='grid'>
            ...
            <motion.div className='grid font-text'>
                ...
                <h1 className='project-text-header'>Personal Budget App - November 2024</h1>
                    ...
                    ●	Incorporated state management for real-time updates of financial categories (e.g., housing, transportation, food).<br></br><br></br>
                    ●	Created reusable functions such as handleTotalIncome and handleAfterExpenses for dynamic calculations.<br></br><br></br>
                    ●	Employed Prettier and ESLint to maintain clean and error-free code formatting.
                    </p>
            </motion.div>
        </motion.div>
    )
