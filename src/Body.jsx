...
return (
    ...
    <div className="body-container">
        ...
        <p className="project-text">
            ...
            and url). <br></br>
            <br></br>● Built a news search app using React, fetching articles
            from the NewsAPI based on user-defined queries.
            <br></br>
            <br></br>● Integrated React Hooks (useState, useEffect) to manage
            API calls and dynamic state updates.<br></br>
            <br></br>● Displayed article data such as title, image, author,
            publish date, description, content, and provided clickable links to
            full articles.<br></br>
            <br></br>● Implemented responsive CSS styling to ensure the web
            design pages have correct scalability across devices.
            <br></br>
        ...
        <p className="project-text">
            ...
            OpenWeatherMap API to provide real-time weather updates. <br></br>
            <br></br>● Implemented a search feature to fetch data based on city
            input, displaying current conditions and a 5-day forecast. <br></br>
            <br></br>● Displayed key metrics such as temperature, conditions,
            humidity, and descriptions in a user-friendly format. <br></br>
            <br></br>● Default data for New York City ensured a functional
            interface upon load. <br></br>
        ...
        <p className="project-text">
            ...
            <br></br>● Incorporated state management for real-time updates of
